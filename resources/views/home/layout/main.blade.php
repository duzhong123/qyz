...
<div class="header">
  <div class="container">
    <div id="weather"></div>
    <div class="toptxt"><a href="/home/login/login">登陆</a>|<a href="/home/login/reg">注册</a><a href="#">加入收藏</a><a href="#">设为首页</a></div>
...
<div class="nav">
  <ul id="navul" class="shouye" v-for="item is data_show">
		<li class="active"><a href="/home/index/index">首页</a></li>
		@foreach($banner as $k=>$v)
		<li><a href="{{$v->n_url}}">{{$v->n_name}}</a></li>
		@endforeach
