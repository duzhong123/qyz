	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					<div class="bbD">
						分类名称：<input type="text" id="cate_name" class="input1" />
					</div>
					<div class="bbD">
						是否显示：<label><input type="radio" name="cate_show" id="cate_show" checked value="1"/>是</label>
						 		 <label><input type="radio" name="cate_show" id="cate_show" value="2"/>否</label>
					</div>
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;排序：<input class="input2"
							type="text" id="cate_sort"/>
					</div>
					<div class="bbD">
						<p class="bbDP">
