	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					<div class="bbD">
						导航栏名称：<input type="text" id="n_name" class="input1" />
					</div>
					<div class="bbD">
						导航栏地址：<input type="text" id="n_url" class="input1" />
					</div>
					<div class="bbD">
						是否显示：<label><input type="radio" name="u_show" id="n_show" checked value="1"/>是</label>
						 		 <label><input type="radio" name="u_show" id="n_show" value="2"/>否</label>
					</div>
					<div class="bbD">
