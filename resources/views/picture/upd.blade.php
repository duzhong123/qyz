			...
			<div class="banneradd bor">
				...
				<div class="baBody">
                    <div class="bbD">
							...
							<div class="show"><img src="{{$res->tu_img}}"  while="50px" height="50px" alt=""></div>
					</div>
					<div class="bbD">
						图片名称：<input type="text" id="tu_name" value="{{$res->tu_name}}" class="input1" />
					</div>
					<div class="bbD">
						选择分类：<label><input type="radio" name="tu_show" id="tu_cate" value="1" {{$res->tu_cate==1?"checked":""}}/>服务指南</label>
						 		 <label><input type="radio" name="tu_show" id="tu_cate" value="2" {{$res->tu_cate==2?"checked":""}}/>在线服务</label>
					</div>					
					<div class="bbD">
						<p class="bbDP">
							<button class="btn_ok btn_yes" data-id="{{$res->tu_id}}" id="tj" href="#">提交</button>
